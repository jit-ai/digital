 <!-- Footer starts
    ...
    <footer class="small-agency-footer  grey-bg">
                ...
                <img src="images/brand-logo.png" alt="Brand Logo" class="img-fluid" style="height:60px ;"><span class="text-logo">Leading <br>Digital<br> Performance</span>
                    ...
                    <div class="col-md-3">
                        <nav class="footer-nav">
                            ...
                            <ul class="footer-menu">
                                <li>
                                    <a <?php echo ($currentPage == 'index.php') ? 'active' : ''; ?> href="index">Hpme</a>
                                </li>
                                <li>
                                    <a <?php echo ($currentPage == 'about-us.php') ? 'active' : ''; ?> href="about-us">About</a>
                                </li>
                                <li>
                                    <a <?php echo ($currentPage == 'services.php') ? 'active' : ''; ?> href="services">Services</a>
                                </li>
                                <li>
                                    <a <?php echo ($currentPage == 'contact.php') ? 'active' : ''; ?> href="contact">Contact Us</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <p class="text-center">&copy; 2025. All rights reserved by Your
                    <a href="#" target="_blank">Company LLC</a>.</p>
            </div>
            <!-- End of .container -->
        </div>
